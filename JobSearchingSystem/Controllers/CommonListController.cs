    ...
    public class CommonListController : Controller
    {
        ...
        public ActionResult CreateCategory(ComCategoryListViewModel model)
        {
            if (ModelState.IsValid && model != null)
            {
                if (!String.IsNullOrEmpty(model.name))
                {
                    ...
                    if (result)
                    {
                        TempData["successmessage"] = "Tạo nhóm lĩnh vực " + model.name + " thành công.";
                    }
                    else
                    {
                        TempData["errormessage"] = "Tạo nhóm lĩnh vực " + model.name + " thất bại!";
                    }
                }
                else
                {
        ...
        public ActionResult UpdateCategory(int id, string name, string description)
        {
            ...
            if (!String.IsNullOrEmpty(name))
            {
                ...
                if (result)
                {
                    TempData["successmessage"] = "Cập nhật nhóm lĩnh vực " + name + " thành công.";
                }
                else
                {
                    TempData["errormessage"] = "Cập nhật nhóm lĩnh vực " + name + " thất bại!";
                }
            }
            else
            {
        ...
        public ActionResult DeleteCategory(int id)
        {
            ...
            if (result)
            {
                TempData["successmessage"] = "Xóa nhóm lĩnh vực thành công.";
            }
            else
            {
                TempData["errormessage"] = "Xóa nhóm lĩnh vực thất bại!";
            }
